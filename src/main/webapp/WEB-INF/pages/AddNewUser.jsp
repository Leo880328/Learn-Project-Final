					...
					<% String action="" ; %>
						...
						<div class="content__inner content__inner--sm">
							<header class="content__title">
								...
								<small></small>
								<div class="actions">
									<a href="" class="actions__item zmdi zmdi-trending-up"></a><a href=""
										class="actions__item zmdi zmdi-check-all"></a>
							...
							<form action="<%=action%>" method="post" class="anu">
								...
								<div class="card new-contact">
									<div class="new-contact__header">
										<input onchange="previewImg(this)" class="zmdi zmdi-camera  " type="file"
											id="imgin"> <a href=""></a><img src="${mb.img}" id="img" alt="" title=""
											width="200" height="150" class="new-contact__img"> <input id="imgPath"
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>帳號</label><input type="text" name="account"
														value="<c:out value='${mb.account}' />" title="帳號" id="account"
														class="form-control" placeholder="*必填"><i
														class="form-group__bar"></i>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<font color="red"><span id="sp5" class="msg"></span></font><i
														class="form-group__bar"></i>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Email </label><input type="text" title="電子郵件"
														...
														class="form-control" placeholder="*必填">
													<font color="red"><span id="sp4" class="msg"></span></font><i
														class="form-group__bar"></i>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>性別</label><select name="sex" id="sex" class="form-control">
														<option>${mb.sex}</option>
														<option value="男生" <c:if test="${mb.sex=='男生'}">
															</c:if>>男生</option>
														<option value="女生" <c:if test="${mb.sex=='女生'}">
															</c:if>>女生</option>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>聯絡電話 </label><input type="text" name="cellphone" size="20"
														id="cellphone" value="<c:out value='${mb.cellphone}' />"
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>生日 </label><input type="date" name="birthday" id="birthday"
														value="<c:out value='${mb.birthday}' />" class="form-control"
											...
											<c:if test="${mb.status !='1'}">
												<div class="col-md-6">
													<div class="form-group">
														<label>學歷 </label><input type="text" name="education" size="50"
															id="education" value="<c:out value='${mb.education}' />"
															class="form-control" placeholder=""><i
															class="form-group__bar"></i>
													</div>
												</div>
										...
										<div class="form-group">
											<label>加入時間</label><input type="date" name="joinDate" id="joinDate"
												value="<c:out value='${mb.joinDate}' />" class="form-control"
												placeholder=""><i class="form-group__bar"></i>
										</div>
										<div class="form-group">
											<label>自我介紹</label>

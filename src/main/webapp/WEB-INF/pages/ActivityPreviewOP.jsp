            ...
            <div class="u-container-style u-grey-5 u-group u-group-3">
              <div class="u-container-layout u-container-layout-3">
                ...
                <div class="u-align-center u-clearfix u-group-elements u-group-elements-1">
                  ...
                  <a onclick="pageNoReduce()" class="u-align-center u-btn u-btn-round u-button-style u-hover-palette-1-light-2 u-palette-1-base u-radius-2 u-btn-3"><span class="u-file-icon u-icon u-text-white"><img src="images/5456801.png" alt=""></span>&nbsp;Back
                  </a>
                  <h3 class="u-text u-text-default u-text-2 totalPages">1</h3>
                </div>
              </div>
            </div>
            <a onclick="ActivityInsert()" class="u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-4"><span class="u-file-icon u-icon u-text-white"><img src="images/748113.png" alt=""></span>&nbsp;新增
            </a>
          </div>
        </div>
      </div>

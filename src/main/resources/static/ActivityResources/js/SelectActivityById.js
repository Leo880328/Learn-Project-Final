    ...
    <div class="u-container-layout u-container-layout-1">
      <div class="u-container-style u-grey-5 u-group u-group-2">
        <div class="u-container-layout u-container-layout-2">
          <h1 class="u-align-center u-custom-font u-font-lobster u-text u-text-1" id="ActivityBeanTitle" data-animation-name=""
            data-animation-duration="0" data-animation-delay="0" data-animation-direction="">${ActivityBean.title}</h1>
          <img class="u-image u-image-default u-image-1" src="${imgPath}" alt="圖片讀取失敗" data-image-width="400" data-image-height="265">
          <h4 class="u-align-left u-text u-text-2">活動結束日期:${endTime.getFullYear()}年${endTime.getMonth()}月${endTime.getDate()}日</h4>
          <div>
          <h4 class="u-align-left u-text u-text-2">活動結束日期:${startTime.getFullYear()}年${startTime.getMonth()}月${startTime.getDate()}日</h4>
